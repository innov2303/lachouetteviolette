          ...
          <nav className="hidden lg:flex items-center gap-1">
            {navLinks.slice(0, 2).map((link) => (
              <a
                ...
                className="px-4 py-2 text-sm font-medium tracking-wide uppercase text-primary hover:text-primary/70 transition-colors"
              >
                {link.name}
              </a>
            ))}
            ...
            <nav className="flex flex-col py-4 px-6">
              {navLinks.map((link) => (
                <a
                  ...
                  className="py-3 text-sm font-medium tracking-wide uppercase text-primary border-b border-border/50 last:border-0"
